INSERT INTO `comida`(`COMIDA_ID`, `COMIDA_NOMBRE`, `COMIDA_DESCRIPCION`, `COMIDA_TIPO`, `COMIDA_PRECIO`) 
VALUES (0,"Desayuno Americano","Rico desayuno con tostadas y bacon",1,5000),
