...
ALTER TABLE MEAL_RESERVATION                         ADD CONSTRAINT MEAL_RESERVATION_RESERVATION_ID_FK 
    FOREIGN KEY MEAL_RESERVATION_RESERVATION_ID      REFERENCES  RESERVATION (RESERVATION_ID);
ALTER TABLE MEAL_RESERVATION                         ADD CONSTRAINT MEAL_RESERVATION_MEAL_ID_FK 
    FOREIGN KEY MEAL_RESERVATION_MEAL_ID             REFERENCES                MEAL (MEAL_ID);
ALTER TABLE ORDER                                    ADD CONSTRAINT ORDER_FUNCTIONARY_ID_FK 
    FOREIGN KEY ORDER (ORDER_FUNCTIONARY_ID)         REFERENCES           V_USER (V_USER_RUN);
