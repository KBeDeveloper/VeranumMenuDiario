...
(
    ...
    INPUT_MEAL_STOCK_ID   INT NOT NULL
);
...
ALTER TABLE INPUT_MEAL                                             ADD CONSTRAINT             INPUT_MEAL_STOCK_ID_FK
    FOREIGN KEY INPUT_MEAL (INPUT_MEAL_STOCK_ID)                   REFERENCES                      STOCK (STOCK_ID);
