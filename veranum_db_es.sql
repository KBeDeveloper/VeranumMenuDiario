CREATE DATABASE IF NOT EXISTS veranum_db;
...
ALTER TABLE COMIDA_RESERVA                       ADD CONSTRAINT COMIDA_RESERVA_RESERVA_ID_FK 
    FOREIGN KEY COMIDA_RESERVA_RESERVA_ID        REFERENCES  RESERVA (RESERVA_ID);
ALTER TABLE COMIDA_RESERVA                       ADD CONSTRAINT COMIDA_RESERVA_COMIDA_ID_FK 
    FOREIGN KEY COMIDA_RESERVA_COMIDA_ID         REFERENCES    COMIDA (COMIDA_ID);
ALTER TABLE PEDIDO                               ADD CONSTRAINT PEDIDO_FUNCIONARIO_ID_FK 
    FOREIGN KEY PEDIDO (PEDIDO_FUNCIONARIO_ID)   REFERENCES USUARIO (USUARIO_RUN);
ALTER TABLE INSUMO                               ADD CONSTRAINT INSUMO_PEDIDO_PEDIDO_ID_FK 
    FOREIGN KEY INSUMO (INSUMO_PEDIDO_PEDIDO_ID) REFERENCES    PEDIDO (PEDIDO_ID);
