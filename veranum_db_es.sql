...
(
    ...
    PEDIDO_DESCRIPCION     VARCHAR(2000) NOT NULL
);
/* DEBIDO A LA APARICION DE MUCHOS PROBLEMAS CON LA VISTA, HEMOS DECIDIDO ELIMINAR ESTA TABLA Y MODIFICAR LA TABLA PEDIDO
